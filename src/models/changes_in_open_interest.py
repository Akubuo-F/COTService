class ChangesInOpenInterest:

    def __init__(self, total: int, speculators: int, hedgers: int):
    ...
    def __repr__(self) -> str:
        return f"Changes In Open Interest(total: {self._total}, speculators: {self._speculators}, hedgers: {self._hedgers})"

    def __str__(self) -> str:
        return self.__repr__()

    def __eq__(self, other: "ChangesInOpenInterest") -> bool:
        is_total_equal: bool = self._total == other._total
        is_speculators_equal: bool = self._speculators == other.speculators
        is_hedgers_equal: bool = self._hedgers == other.hedgers
        return is_speculators_equal \
